...
- **Action:** Highlight text or open the AI Tutor (`AssistantChat.svelte`) and ask: *"How does a subnet mask work according to my notes?"*
...
- **Narrative:** "Instead of an opaque percentage, the system explains: *'Your mastery is low because 2 of your recent answers were incorrect and you have pending due flashcards.'*"
...
- **Narrative:** "The Learning Intelligence Engine answers: *'What should this student study next?'* It dynamically prioritizes reviewing due flashcards and practicing weak areas before starting downstream modules."
